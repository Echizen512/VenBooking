<?php include '../PHP/get-PayPal.php'; ?>
...
<body>
    ...
    <div class="container mt-5 fadeIn">
        <div class="card custom-card slideInUp">
            <div class="card-body">
                <h2 class="card-title"><i class="fab fa-paypal me-2 text-primary"></i> Lista de Transferencias PayPal</h2>
    ...
    <?php include '../Includes/Modal-PayPal.php'; ?>
