<?php include '../PHP/get-Binance.php'; ?>
...
<body>
    ...
    <div class="container mt-5 fadeIn">
        <div class="card custom-card slideInUp">
            <div class="card-body">
                <h2 class="card-title"><i class="fab fa-btc me-2" style="color: #f4c20d;"></i> Lista de Transferencias Binance</h2>
    ...
    <?php include '../Includes/Modal-Binance.php'; ?>
