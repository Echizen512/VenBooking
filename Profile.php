                        ...
                        <div class="row justify-content-center">
                            ...
                            if ($result_favorite_inns->num_rows > 0) {
                                while ($row = $result_favorite_inns->fetch_assoc()) {
                                    ...
                                    echo '<p class="card-text text-muted" style="font-size: 14px;"><i class="fas fa-tags me-1"></i>' . htmlspecialchars($row["category_name"]) . '</p>';
                ...
                <div class="row justify-content-center">
                    ...
                    if ($result_reservations->num_rows > 0) {
                        while ($row = $result_reservations->fetch_assoc()) {
                            ...
                            echo '<img src="' . htmlspecialchars($row["image_url"]) . '" alt="Inn Image" class="posada-img rounded-circle mb-3">';
                            echo '<h5 class="card-title text-primary mb-2" style="font-size: 16px;">' . htmlspecialchars($row["inn_name"]) . '</h5>';
                            echo '<p class="card-text" style="font-size: 14px;"><i class="fas fa-calendar-alt me-1"></i>Desde: ' . htmlspecialchars($start_date) . '</p>';
                            echo '<p class="card-text" style="font-size: 14px;"><i class="fas fa-calendar-alt me-1"></i>Hasta: ' . htmlspecialchars($end_date) . '</p>';
