...
<div class="row mb-5">
    <div class="col-12 d-flex justify-content-between align-items-center mb-3">
        <h3 class="mb-0" style="font-size: 28px;"><i class="fas fa-bed" style="font-size: 28px;"></i> Habitaciones</h3>
        <button class="btn btn-success" style="font-size: 14px;" data-bs-toggle="modal" data-bs-target="#addRoomModal">
            Agregar Habitación
        </button>
    </div>
    ...
    <?php while ($room = $result_rooms->fetch_assoc()): ?>
        <div class="col-md-4">
            <div class="card shadow-sm mb-4">
                <img src="<?= $room['image_url']; ?>" class="card-img-top" alt="Imagen de la Habitación" style="height: 200px; object-fit: cover;">
                <div class="card-body">
                    <h5 style="font-size: 18px;" class="card-title"><?= $room['type']; ?> - Habitación <?= $room['room_number']; ?></h5>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <button class="btn btn-primary " style="font-size: 16px;" data-bs-toggle="modal" data-bs-target="#editRoomModal<?= $room['id']; ?>">
                        ...
                        <form method="POST" action="<?= $_SERVER['PHP_SELF'] . '?id=' . $inn_id; ?>" style="display: inline;">
                            ...
                            <button type="submit" style="font-size: 16px;" class="btn btn-sm <?= $room['block'] ? 'btn-danger' : 'btn-outline-success'; ?> ">
                        ...
                        <div class="modal-body">
                            <form method="POST">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="image_url" value="<?= $room['image_url']; ?>" required>
                                </div>
                                <div class="form-group mb-3">
...
<div class="row mb-5">
    <div class="col-12 d-flex justify-content-between align-items-center mb-3">
        <h3 class="mb-0" style="font-size: 28px;"><i class="fas fa-car" style="font-size: 28px;"></i> Vehículos</h3>
        <button class="btn btn-success" style="font-size: 14px;" data-bs-toggle="modal" data-bs-target="#addVehicleModal">
            Agregar Vehículo
        </button>
    </div>
    ...
    <?php if ($result_vehicles->num_rows > 0): ?>
        <?php while ($vehicle = $result_vehicles->fetch_assoc()): ?>
            <div class="col-md-4">
                <div class="card shadow-sm mb-4">
                    <img src="<?= $vehicle['image_url']; ?>" class="card-img-top" alt="Imagen del Vehículo" style="height: 200px; object-fit: cover;">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <button class="btn btn-primary" style="font-size: 16px;" data-bs-toggle="modal" data-bs-target="#editVehicleModal<?= $vehicle['id']; ?>">
                                <i class="fas fa-edit"></i>
                            </button>
                            <form method="POST" action="<?= $_SERVER['PHP_SELF'] . '?id=' . $inn_id; ?>" style="display: inline;">
                                ...
                                <button type="submit" style="font-size: 16px;" class="btn btn-sm <?= $vehicle['block'] ? 'btn-danger' : 'btn-outline-success'; ?>">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST">
                                ...
                                <div class="form-group mb-3">
                                    <label for="image_url">URL de Imagen</label>
                                    <input type="text" class="form-control" name="image_url" value="<?= $vehicle['image_url']; ?>" required>
                                </div>
                                <br>
                                <div class="d-flex justify-content-center">
