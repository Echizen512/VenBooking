                        ...
                        <ul class="nav-menu">
                            ...
                            <li class="nav-item">
                                <a href="./Destinations.php" class="nav-link">
                                    ...
                                    <span style="font-size: 14px">Destinos</span>
                                </a>
                            </li>
                            <li class="nav-item text-sm">
                                <a href="./Inns.php" class="nav-link">
                                    <i class="fas fa-bed nav-icon"></i>
                                    <span style="font-size: 14px">Posadas</span>
                                </a>
                            </li>
                        </ul>
                    </nav>
            ...
            <div class="mobile-menu" id="mobileMenu">
                <div class="mobile-menu-content">
                    <nav class="mobile-nav">
                        ...
                        <a href="./Destinations.php" class="mobile-nav-link">
                            <div class="mobile-nav-icon">
                                <i class="fas fa-map-marker-alt"></i>
                            </div>
                            <span>Destinos</span>
                        </a>
                        <a href="./Inns.php" class="mobile-nav-link">
                            <div class="mobile-nav-icon">
