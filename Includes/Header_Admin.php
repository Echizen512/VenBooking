...
<body>
    ...
    <div class="sidebar bg-success">
        ...
        <div class="dropdown-container">
            ...
            <a href="../Enterprise/inns.php">
                <i class="fas fa-hotel me-2" style="color: #9eeaff;"></i> Posadas
            </a>
            <a href="../Enterprise/reservation.php">
