    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <button type="button" class="btn btn-success btn-sm d-flex align-items-center" data-toggle="modal" data-target="#posadaModal" title="Crear Posada" style="font-size: 16px;">
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center align-items-center gap-2">
                                            ...
                                            <form action="toggle_block.php" method="POST" class="m-0">
                                                ...
                                                <button type="submit" class="btn btn-warning btn-sm" title="Bloquear/Desbloquear">
...
<!-- Modal -->
<div class="modal fade" id="posadaModal" tabindex="-1" role="dialog" aria-labelledby="posadaModalLabel" aria-hidden="true">
