            ...
            <article class="page-article" itemprop="blogPost">
                ...
                if (isset($_GET['inn_id']) && !empty($_GET['inn_id'])) {
                    ...
                    if ($result_inn_detail->num_rows > 0) {
                        ...
                        ?>
                        <div class="card mb-3">
                            <img src="<?php echo $row['inn_image_url']; ?>" class="card-img-top" alt="Posada Image"
                                style="margin-top: 0px; margin-bottom: 0px;">
                            <div class="card-body">
                                <p class="card-text" style="font-size: 18px"><i class="fas fa-info-circle"></i>
                                    <?php echo $row['description']; ?></p>
                                <ul class="list-unstyled">
                                    <li style="font-size: 14px"><i class="fas fa-envelope"></i> <span>Email:</span>
                                        <?php echo $row['email']; ?></li>
                                    <li style="font-size: 14px"><i class="fas fa-phone"></i> <span>Teléfono:</span>
                                        <?php echo $row['phone']; ?></li>
                                    <li style="font-size: 14px"><i class="fas fa-map-marker-alt"></i> <span>Ubicación:</span>
                                        <?php echo $row['state_name'] . ', ' . $row['municipality_name'] . ', ' . $row['parish_name']; ?>
                                    </li>
                                    <li style="font-size: 14px"><i class="fas fa-list"></i> <span>Categoría:</span>
