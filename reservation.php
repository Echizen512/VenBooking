                    ...
                    <div class="card-body p-4">
                        <form id="reservationForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                <label for="start_date" class="form-label" style="font-size: 14px;"><i class="fas fa-calendar-alt"></i> Fecha de Inicio:</label>
                                <input type="date" id="start_date" name="start_date" class="form-control" required>
                            </div>

                            <!-- Fecha de Fin -->
                            <div class="form-group mb-3">
                                <label for="end_date" class="form-label" style="font-size: 14px;" style="font-size: 14px;"><i class="fas fa-calendar-alt"></i> Fecha de Fin:</label>
                                <input type="date" id="end_date" name="end_date" class="form-control" required>
                            </div>

                            <!-- Selección de Habitación -->
                            <div class="form-group mb-3">
                                <label for="room_id" class="form-label" style="font-size: 14px;"><i class="fas fa-door-open"></i> Habitación:</label>
                            ...
                            <!-- Método de Pago -->
                            <div class="form-group mb-3">
                                <label for="payment_method" class="form-label" style="font-size: 14px;"><i class="fas fa-money-check-alt"></i> Método de Pago:</label>
                            ...
                            <div class="form-group mb-3" id="receiptGroup" style="display: none;">
                                <label for="receipt" class="form-label" style="font-size: 14px;"><i class="fas fa-receipt"></i> Comprobante de Pago (JPG, PNG, PDF):</label>
                                <input type="file" id="receipt" name="receipt" class="form-control" accept=".jpg,.jpeg,.png,.pdf">
                            </div>

                            <!-- Código de Referencia -->
                            <div class="form-group mb-3">
                                <label for="reference_code" class="form-label" style="font-size: 14px;"><i class="fas fa-hashtag"></i> Código de Referencia:</label>
                                <input type="text" id="reference_code" name="reference_code" class="form-control" required>
                            </div>

                            <!-- Monto Total -->
                            <div class="form-group mb-3">
                                <label for="monto_total" class="form-label" style="font-size: 14px;"><i class="fas fa-dollar-sign"></i> Monto Total:</label>
                                <input type="text" id="monto_total" class="form-control" readonly>
                            </div>

                            <!-- Botón de Confirmar -->
                            <div class="d-flex justify-content-center">
                                <button type="submit" class="btn btn-success px-5" style="font-size: 12px;"> Confirmar Reserva</button>
                            </div>
