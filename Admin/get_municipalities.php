...
<div class="container mt-5">
    <div class="card">
        <div class="card-body">
            ...
            <button class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#createModal"><i class="fas fa-plus"></i> Crear Municipio</button>
            </div>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>
                                        ...
                                        <td class='text-center'><img src='{$row['flag_url']}' alt='Bandera del Municipio' style='width: 50px;'></td>
